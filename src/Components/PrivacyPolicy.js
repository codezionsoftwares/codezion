          ...
          <div className="row">
              <div className="col-lg-12">
                <div className="subheader">
                  ...
                  <span><Link to="/">Home <i className="fa fa-chevron-right"></i></Link> Privacy Policy</span>
                </div>
              </div>
          </div>
        </div>
      ...
      <section className='section-padding'>
        <div className="container">
          <div className="pricacy-policy-text">
            <h4>Privacy Policy for Codezion Software Private Limited</h4>
            <h5>Effective Date: 23/09/2024</h5>
            <p>This privacy notice for Codezion Softwares Pvt. Ltd. (doing business as Codezion) ('we', 'us', or 'our'), describes how and why we might collect, store, use, and/or share ('process') your
              information when you use our services ('Services'), such as when you:</p>
              <ul>
                <li>Visit our website at https://www.codezion.com/, or any website of ours that links to this privacy notice</li>
                <li>Engage with us in other related ways, including any sales, marketing, or events</li>
              </ul>
            <p><strong>Questions or concerns?</strong> Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our
              Services. If you still have any questions or concerns, please contact us at <Link to="#">info@codezion.com.</Link></p>
            ...
            <p><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the
              Services, the choices you make, and the products and features you use. Learn more about personal information you disclose to us.</p>
            ...
            <p><strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to
              comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. Learn more about how we process your information.</p>
            <p><strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. Learn more about when
                and with whom we share your personal information.</p>
            <p><strong>How do we keep your information safe?</strong> We have organisational and technical processes and procedures in place to protect your personal information. However, no electronic
                ...
                unauthorised third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about how we keep your information safe.</p>
            <p><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn
              more about your privacy rights.</p>
            <p><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a data subject access request, or by contacting us. We will consider and act upon any
              request in accordance with applicable data protection laws.</p>
            ...
            <h2>1. WHAT INFORMATION DO WE COLLECT? (h2)</h2>
            <h3>Personal information you disclose to us (h3)</h3>
            <p><strong>In Short:</strong> We collect personal information that you provide to us.</p>
            <p>We collect personal information that you voluntarily provide to us when you express an interest in obtaining information about us or our products and Services, when you participate in
              activities on the Services, or otherwise when you contact us.</p>
            <p><strong>Personal Information Provided by You.</strong> The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make, and the
            ...
            <h3>Information automatically collected (h3)</h3>
            ...
            <p>We automatically collect certain information when you visit, use, or navigate the Services. This information does not reveal your specific identity (like your name or contact information) but
            ...
            <h2>2. HOW DO WE PROCESS YOUR INFORMATION?  (H2)</h2>
            <p><strong>In Short:</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also
              process your information for other purposes with your consent.</p>
            <h6>We process your personal information for a variety of reasons, depending on how you interact with our Services, including:</h6>
            <ul>
              <li><strong>To respond to user inquiries/offer support to users.</strong> We may process your information to respond to your inquiries and solve any potential issues you might have with the requested service.</li>
              <li><strong>To save or protect an individual's vital interest.</strong> We may process your information when necessary to save or protect an individual's vital interest, such as to prevent harm.</li>
            </ul>
            <h2>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?  (H2)</h2>
            <p><strong>In Short:</strong> We only process your personal information when we believe it is necessary and we have a valid legal reason (i.e. legal basis) to do so under applicable law, like with your
              consent, to comply with laws, to provide you with services to enter into or fulfil our contractual obligations, to protect your rights, or to fulfil our legitimate business interests.</p>
            <h6>If you are located in the EU or UK, this section applies to you.</h6>
            ...
            <h6>If you are located in Canada, this section applies to you.</h6>
            ...
            <h2>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?  (H2)</h2>
            ...
            <h2>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?     (H2)</h2>
            ...
            <h2>6. HOW LONG DO WE KEEP YOUR INFORMATION?         (H2)</h2>
            ...
            <h2>7. HOW DO WE KEEP YOUR INFORMATION SAFE?  (H2)</h2>
            ...
            <p>If you have questions or comments about your privacy rights, you may email us at info@codezion.com.</p>
            <h2>10. CONTROLS FOR DO-NOT-TRACK FEATURES      (H2)</h2>
            ...
            <h2>11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?   (H2)</h2>
            <p><strong>In Short:</strong> If you are a resident of California, Colorado, Connecticut, Virginia or Utah, you are granted specific rights regarding access to your personal information.</p>
              ...
              <table className='privacy-policy'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Images and audio, video or call recordings created in connection with our business</td>
                    <td>No</td>
                  </tr>
                  <tr>
                    <td></td>
            ...
            <p>To exercise these rights, you can contact us by submitting a data subject access request, by visiting https://www.codezion.com/contact/, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.</p>
            ...
            <p>To submit a request to exercise these rights described above, please email info@codezion.com or submit a data subject access request.</p>
            <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at info@codezion.com. Within forty-five (45) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
            ...
            <p>To submit a request to exercise these rights described above, please email info@codezion.com or submit a data subject access request.</p>
            <p>If we decline to take action regarding your request and you wish to appeal our decision, please email us at info@codezion.com. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.</p>
            ...
            <h6>Exercise your rights provided under the Virginia VCDPA</h6>
            <p>You may contact us by email at info@codezion.com or submit a data subject access request.</p>
            ...
            <h6>Right to appeal</h6>
            <p>If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it. If you wish to appeal our decision, please email us at info@codezion.com. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may contact the <Link to="">Attorney General to submit a complaint.</Link></p>
            <h2>12. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?   (H2)</h2>
            ...
            <p>If you believe we are unlawfully processing your personal information, you have the right to submit a complaint about a breach of the Australian Privacy Principles to the Office of the <Link to="">Australian Information Commissioner</Link> and a breach of New Zealand's Privacy Principles to the <Link to="">Office of New Zealand Privacy Commissioner.</Link></p>
            ...
            <span>The Information Regulator (South Africa)</span><br />
            <span>General enquiries: enquiries@inforegulator.org.za</span><br />
            <span>Complaints (complete POPIA/PAIA form 5): paiacomplaints@inforegulator.org.za & popiacomplaints@inforegulator.org.za</span>
            <h2>13. DO WE MAKE UPDATES TO THIS NOTICE? (H2)</h2>
            ...
            <h2>14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?  (H2)</h2>
            <p>If you have questions or comments about this notice, you may email us at info@codezion.com or contact us by post at:</p>
            <h5>15. Contact Us</h5>
            <h6>Codezion Software Private Limited</h6>
            <ul>
