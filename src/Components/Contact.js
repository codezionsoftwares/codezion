...
function Contact() {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="Reach out to us to discuss your project requirements and receive a free quote or project estimation. We're ready to respond promptly and assist you with your needs!"/>
      ...
      <meta property="og:description" content="Reach out to us to discuss your project requirements and receive a free quote or project estimation. We're ready to respond promptly and assist you with your needs!"/>
      ...
      <meta name="twitter:description" content="Reach out to us to discuss your project requirements and receive a free quote or project estimation. We're ready to respond promptly and assist you with your needs!"/>
          ...
          <div className="row">
              <div className="col-lg-12">
                <div className="subheader">
                  <h1>Contact Us</h1>
                  <span><Link to="/">Home <i className="fa fa-chevron-right"></i></Link> Contact Us</span>
                </div>
              </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="contact-title">
                <p>Get In Touch</p>
                <h2>Get answers of your queries by filling this form with all the details requested.</h2>
                ...
                <div className="media">
                  ...
                  <div className="media-body">
                    ...
                    <div className="fbox-content">C-188, B-2, Ground Floor, Ayesha Majestic Near LBS College Sunder Marg Tilak Nagar, Raja Park, Jaipur, Rajasthan 302004</div>
                  </div>
                </div>
                <div className="media">
            ...
            <div className="col-lg-6">
            {status === 'success' && <p className="success-message">Your message was sent successfully!</p>}
            {status === 'failure' && <p className="error-message">There was an error sending your message. Please try again.</p>}
              ...
              <div className="contact-form">
                <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="btn-thm-main">SEND NOW</button>
                </form>
              </div>
            </div>
          </div>
